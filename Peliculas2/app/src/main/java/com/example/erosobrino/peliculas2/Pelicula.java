...
public class Pelicula implements Serializable {
    ...
    public String getFecha() {
        ...
        String date = null;
        date = formato.format(this.fecha);
        return date;
    }
    ...
    public static void setPeliculas(ArrayList<Pelicula> peliculas2) {
    ...
    public static ArrayList<Pelicula> rellenaPeliculas() {
        ...
        martian.setSinopsis("Durante una misión a Marte de la nave tripulada Ares III, una fuerte tormenta se desata, por lo que, tras haber dado por desaparecido y muerto " +
                "al astronauta Mark Watney (Matt Damon), sus compañeros toman la decisión de irse; sin embargo, ha sobrevivido, pero está solo y sin apenas recursos en el planeta. " +
                "Con muy pocos medios, deberá recurrir a sus conocimientos, su sentido del humor y un gran instinto de supervivencia para lograr sobrevivir y comunicar a la Tierra que " +
                "todavía está vivo, esperando que acudan en su rescate.");
